                        ...
                        <form action="{{ route('site.add_to_cart') }}" method="POST">
                            ...
                            <div class="product-category">
                                ...
                                <ul>
                                    <li>
                                        <a
                                            href="{{ route('site.category',$product['id'],$product['category_id']) }}">{{ $product['category'] }}
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="tab-content patternbg">
                            <div id="details" class="tab-pane fade active in">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    ...
                                    culpa qui
                                    officia deserunt mollit anim id est laborum. Sed ut per spici</p>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis delectus quidem
                                    repudiandae
                                    veniam distinctio repellendus magni pariatur molestiae asperiores animi, eos quod iusto
                                    hic doloremque
                                    iste a, nisi iure at unde molestias enim fugit, nulla voluptatibus. Deserunt voluptate
                                    tempora aut
                                    illum harum, deleniti laborum animi neque, praesentium explicabo, debitis ipsa?</p>
                            </div>
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p>
                                                    ...
                                                    magna ut ante eleifend
                                                    eleifend.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod
                                                    laborum minima,
                                                    reprehenderit laboriosam officiis praesentium? Impedit minus provident
                                                    assumenda quae.
                                                </p>
                                            </div>
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque at
                                                    magna ut ante eleifend
                                                    eleifend. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                    Magni natus, nostrum iste
                                                    non delectus atque ab a accusantium optio, dolor!
                                                </p>
